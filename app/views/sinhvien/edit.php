...
<div class="container">
    ...
    <div class="card-form-premium">
        <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-3">
            <h2 class="h4 fw-bold mb-0 text-slate-800"><i class="fa-solid fa-user-pen text-primary me-2"></i> Chỉnh sửa thông tin sinh viên</h2>
        ...
        <form action="/sinhvien/update/<?php echo $sinhvien['id']; ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="hoten" name="hoten" class="form-control form-control-premium" placeholder="Nhập họ và tên đầy đủ" value="<?php echo htmlspecialchars($sinhvien['hoten']); ?>" required>
            </div>

            <!-- MSSV -->
            <div class="mb-3">
                <label for="mssv" class="form-label form-label-premium">Mã số sinh viên (MSSV)</label>
                <input type="text" id="mssv" name="mssv" class="form-control form-control-premium" placeholder="Nhập đúng 6 chữ số" value="<?php echo htmlspecialchars($sinhvien['mssv']); ?>" maxlength="6" required>
            ...
            <div class="mb-3">
                ...
                <select id="gioi_tinh" name="gioi_tinh" class="form-select form-control-premium" required>
                    <option value="Nam" <?php echo (trim($sinhvien['gioi_tinh']) === 'Nam') ? 'selected' : ''; ?>>Nam</option>
                    <option value="Nữ" <?php echo (trim($sinhvien['gioi_tinh']) === 'Nữ') ? 'selected' : ''; ?>>Nữ</option>
                    <option value="Khác" <?php echo (trim($sinhvien['gioi_tinh']) === 'Khác') ? 'selected' : ''; ?>>Khác</option>
                </select>
            </div>
